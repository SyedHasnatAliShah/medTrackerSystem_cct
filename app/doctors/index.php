...
<script>
    $(function(){
        $('.dt-init').DataTable({
            ...
            serverSide: true,
            ajax: {
                url:"../classes/Master.php?f=dt_doctors",
                method:"POST"
            },
            columns: [{
                    data: 'id',
                ...
                },
                {
                    ...
                    render:function(data, type, row, meta){
                        return '<p class="m-0 text-truncate w-100">'+row.clinicname+'</p>';
                        },
                    width:"35%"
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        el.find('.edit_data').attr("href","./?page=doctors/manage_doctors&id="+row.id)
            ...
            drawCallback: function(settings) {
                ...
                $('.view_data').click(function(){
                    uni_modal("View doctors Details","doctors/view_details.php?id="+$(this).attr('data-id'))
                })
                $('.delete_data').click(function(){
                    _conf("Are you sure to delete <b>"+$(this).attr('data-name')+"</b> from list?","delete_doctor",[$(this).attr('data-id')])
                })
            },
            language:{
                oPaginate: {
    ...
    function delete_doctor($id){
        ...
        el.hide()
        $.ajax({
            url: '../classes/Master.php?f=delete_doctors',
            method: 'POST',
            data: {
                id: $id
            },

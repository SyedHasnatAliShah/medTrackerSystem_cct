                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-3 input-group input-group-dynamic is-filled">
                         ...
                         <div class="form-group mb-3 input-group input-group-dynamic is-filled">
                            <label for="dob" class="form-label">Date of Birth <span class="text-primary">*</span></label>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-3 input-group input-group-dynamic is-filled">
                            <label for="address" class="form-label">Address <span class="text-primary">*</span></label>
                            <input type="text" name="address" id="address" class="form-control form-control-lg" value="<?= isset($address) ?  $address : '' ?>" required="required">
                        </div>
                        <div class="form-group mb-3 input-group input-group-dynamic is-filled">

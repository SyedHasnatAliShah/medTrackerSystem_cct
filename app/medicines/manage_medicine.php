...
$doctorsResult = $conn->query("SELECT * FROM `doctors_list`");
?>
<section class="py-5">
    <div class="container">
            ...
            <div class="col-lg-8 col-md-10 col-sm-12 col-xs-12">
                <form action="" id="medicine-form" class="py-3">
                    ...
                    <div class="form-group mb-3">
                     ...
                     <div class="form-group mb-3">
                        <label for="description" class="form-label">Doctor <span class="text-primary">*</span></label>
                          
                        <select class="form-control border rounded-0 form-select px-2" name="doctor_id" id="doctor" required>
